...
public class BuyerDashboardController implements Initializable {
    ...
    public TableColumn<PostOrder, String> postOrderSellerColumn;
        ...
        try {
            ...
            if (selected != null) {
                if (selected.canConfirm()) {
                    ...
                    MessageDialog.ShowDialog("Error", "You can only confirm the order after the due date", "error");
                }
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        switch (page) {
            ...
            case "buyer-post-orders":
                ...
                postOrderSellerColumn.setCellValueFactory(new PropertyValueFactory<>("Seller"));
